...
% (in arg1 and arg2, respectively). In this version of the code, A
% represent the downscaling operation through bicubic interpolation. This
% can be changed to be in line how b was obtained. 
%
